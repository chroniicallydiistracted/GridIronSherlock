...
class TradeEstimateResponseReplacementImpact(BaseModel):
    """
    TradeEstimateResponseReplacementImpact
    """ # noqa: E501
    team_id: Optional[StrictStr] = Field(default=None, description="Canonical UUID identifier.", alias="teamId")
    delta: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["teamId", "delta"]
