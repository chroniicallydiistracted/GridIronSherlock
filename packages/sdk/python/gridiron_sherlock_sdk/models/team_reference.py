...
class TeamReference(BaseModel):
    ...
    league_id: StrictStr = Field(alias="leagueId")
    name: StrictStr
    abbreviation: Optional[StrictStr] = None
    manager: Optional[StrictStr] = None
    record: Optional[TeamReferenceRecord] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["teamId", "leagueId", "name", "abbreviation", "manager", "record"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "record": TeamReferenceRecord.from_dict(obj["record"]) if obj.get("record") is not None else None
        })
