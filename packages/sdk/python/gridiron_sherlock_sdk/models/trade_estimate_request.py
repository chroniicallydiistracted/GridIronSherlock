...
class TradeEstimateRequest(BaseModel):
    ...
    from_team_id: StrictStr = Field(description="Canonical UUID identifier.", alias="fromTeamId")
    to_team_id: StrictStr = Field(description="Canonical UUID identifier.", alias="toTeamId")
