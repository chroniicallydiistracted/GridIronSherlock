...
class OAuthCallbackResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["provider", "status", "linkedAccount", "redirect", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "linkedAccount": LinkedAccount.from_dict(obj["linkedAccount"]) if obj.get("linkedAccount") is not None else None,
