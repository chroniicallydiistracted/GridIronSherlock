...
class WaiverListResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["total", "page", "pageSize", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [WaiverRecommendation.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
