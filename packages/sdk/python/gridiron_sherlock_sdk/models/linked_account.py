...
class LinkedAccount(BaseModel):
    ...
    needs_reauth: StrictBool = Field(alias="needsReauth")
    error_code: Optional[StrictStr] = Field(default=None, alias="errorCode")
    error_message: Optional[StrictStr] = Field(default=None, alias="errorMessage")
    __properties: ClassVar[List[str]] = ["provider", "status", "scopes", "linkedAt", "lastSyncAt", "needsReauth", "errorCode", "errorMessage"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['linked', 'pending', 'error']):
            raise ValueError("must be one of enum values ('linked', 'pending', 'error')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "needsReauth": obj.get("needsReauth"),
