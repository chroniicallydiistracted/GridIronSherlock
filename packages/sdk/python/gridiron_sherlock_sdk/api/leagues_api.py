...
class LeaguesApi:
    ...
    def _get_league_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/leagues/{leagueId}',
    ...
    def list_leagues(
        ...
        _param = self._list_leagues_serialize(
            page=page,
            page_size=page_size,
            season=season,
            provider=provider,
    ...
    @validate_call
    def list_leagues_with_http_info(
        self,
        page: Optional[Annotated[int, Field(strict=True, ge=1)]] = None,
        page_size: Optional[Annotated[int, Field(le=200, strict=True, ge=1)]] = None,
        season: Optional[StrictInt] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LeagueListResponse]:
        """List leagues for the authenticated user
    ...
    @validate_call
    def list_leagues_without_preload_content(
        self,
        page: Optional[Annotated[int, Field(strict=True, ge=1)]] = None,
        page_size: Optional[Annotated[int, Field(le=200, strict=True, ge=1)]] = None,
        season: Optional[StrictInt] = None,
