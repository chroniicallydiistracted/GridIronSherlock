...
class RefreshApi:
    ...
    def trigger_refresh(
        ...
        _param = self._trigger_refresh_serialize(
            scope=scope,
    ...
    @validate_call
    def trigger_refresh_with_http_info(
        self,
        scope: ScopeId,
        refresh_request: Optional[RefreshRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def trigger_refresh_without_preload_content(
        self,
        scope: ScopeId,
        refresh_request: Optional[RefreshRequest] = None,
        _request_timeout: Union[
    ...
    def _trigger_refresh_serialize(
        self,
        scope,
        refresh_request,
        _request_auth,
