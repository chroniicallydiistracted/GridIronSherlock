...
class TestProjectionSummary(unittest.TestCase):
    """ProjectionSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectionSummary:
        """Test ProjectionSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectionSummary`
        """
        model = ProjectionSummary()
        if include_optional:
    ...
    def testProjectionSummary(self):
        """Test ProjectionSummary"""
