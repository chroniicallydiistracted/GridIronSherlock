...
class TestOptimizationSlot(unittest.TestCase):
    """OptimizationSlot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OptimizationSlot:
        """Test OptimizationSlot
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OptimizationSlot`
        """
        model = OptimizationSlot()
        if include_optional:
            return OptimizationSlot(
                slot = '',
