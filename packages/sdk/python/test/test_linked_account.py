...
class TestLinkedAccount(unittest.TestCase):
    """LinkedAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkedAccount:
        """Test LinkedAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkedAccount`
        """
        model = LinkedAccount()
        if include_optional:
