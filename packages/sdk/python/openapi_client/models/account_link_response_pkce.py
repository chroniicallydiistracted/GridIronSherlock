...
class AccountLinkResponsePkce(BaseModel):
    """
    AccountLinkResponsePkce
    """ # noqa: E501
    code_challenge: StrictStr = Field(alias="codeChallenge")
    code_challenge_method: StrictStr = Field(alias="codeChallengeMethod")
    __properties: ClassVar[List[str]] = ["codeChallenge", "codeChallengeMethod"]
