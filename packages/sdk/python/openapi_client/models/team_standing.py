...
class TeamStanding(BaseModel):
    ...
    points_for: Union[StrictFloat, StrictInt] = Field(alias="pointsFor")
    points_against: Union[StrictFloat, StrictInt] = Field(alias="pointsAgainst")
    streak: Optional[StrictStr] = None
    notes: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["team", "rank", "pointsFor", "pointsAgainst", "streak", "notes"]
