...
class RefreshResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["scope", "status", "enqueuedAt", "estimatedCompletion", "context", "provenance"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['queued', 'in-progress', 'skipped']):
            raise ValueError("must be one of enum values ('queued', 'in-progress', 'skipped')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "estimatedCompletion": obj.get("estimatedCompletion"),
