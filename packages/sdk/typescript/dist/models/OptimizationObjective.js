 ...
 */
export function instanceOfOptimizationObjective(value) {
    if (!('focus' in value) || value['focus'] === undefined)
        return false;
    return true;
}
export function OptimizationObjectiveFromJSON(json) {
    return OptimizationObjectiveFromJSONTyped(json, false);
}
export function OptimizationObjectiveFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function OptimizationObjectiveToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
