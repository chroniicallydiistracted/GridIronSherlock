 ...
 */
export function instanceOfRecentGame(value) {
...
export function RecentGameFromJSON(json) {
    return RecentGameFromJSONTyped(json, false);
}
export function RecentGameFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function RecentGameToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
