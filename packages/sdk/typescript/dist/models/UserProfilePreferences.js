 ...
 */
export function instanceOfUserProfilePreferences(value) {
    return true;
}
export function UserProfilePreferencesFromJSON(json) {
    return UserProfilePreferencesFromJSONTyped(json, false);
}
export function UserProfilePreferencesFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UserProfilePreferencesToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
