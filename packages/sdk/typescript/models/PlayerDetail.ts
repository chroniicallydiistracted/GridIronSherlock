...
import {
    ...
    PlayerDetailProjectionsToJSONTyped,
...
export function PlayerDetailToJSON(json: any): PlayerDetail {
    return PlayerDetailToJSONTyped(json, false);
}

export function PlayerDetailToJSONTyped(value?: PlayerDetail | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
