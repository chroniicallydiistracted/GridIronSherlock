...
export function InjuryStatusToJSON(json: any): InjuryStatus {
    return InjuryStatusToJSONTyped(json, false);
}

export function InjuryStatusToJSONTyped(value?: InjuryStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
