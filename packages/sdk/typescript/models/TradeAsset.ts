...
export function TradeAssetToJSON(json: any): TradeAsset {
    return TradeAssetToJSONTyped(json, false);
}

export function TradeAssetToJSONTyped(value?: TradeAsset | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
