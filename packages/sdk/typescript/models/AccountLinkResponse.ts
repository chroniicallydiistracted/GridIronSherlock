...
import {
    ...
    AccountLinkResponsePkceToJSONTyped,
...
export function AccountLinkResponseToJSON(json: any): AccountLinkResponse {
    return AccountLinkResponseToJSONTyped(json, false);
}

export function AccountLinkResponseToJSONTyped(value?: AccountLinkResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
