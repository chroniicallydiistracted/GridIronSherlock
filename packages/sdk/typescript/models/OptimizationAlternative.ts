...
import {
    ...
    OptimizationAlternativeChangesInnerToJSONTyped,
...
export function OptimizationAlternativeToJSON(json: any): OptimizationAlternative {
    return OptimizationAlternativeToJSONTyped(json, false);
}

export function OptimizationAlternativeToJSONTyped(value?: OptimizationAlternative | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
