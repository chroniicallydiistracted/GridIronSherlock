...
export function LineupSlotToJSON(json: any): LineupSlot {
    return LineupSlotToJSONTyped(json, false);
}

export function LineupSlotToJSONTyped(value?: LineupSlot | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
