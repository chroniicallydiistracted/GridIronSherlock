...
export function ProjectionRecordUsageToJSON(json: any): ProjectionRecordUsage {
    return ProjectionRecordUsageToJSONTyped(json, false);
}

export function ProjectionRecordUsageToJSONTyped(value?: ProjectionRecordUsage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
