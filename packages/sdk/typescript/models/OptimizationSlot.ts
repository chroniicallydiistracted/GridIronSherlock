...
export function OptimizationSlotToJSON(json: any): OptimizationSlot {
    return OptimizationSlotToJSONTyped(json, false);
}

export function OptimizationSlotToJSONTyped(value?: OptimizationSlot | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
