...
import {
    ...
    WaiverRecommendationReplacementComparisonToJSONTyped,
...
export function WaiverRecommendationToJSON(json: any): WaiverRecommendation {
    return WaiverRecommendationToJSONTyped(json, false);
}

export function WaiverRecommendationToJSONTyped(value?: WaiverRecommendation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
