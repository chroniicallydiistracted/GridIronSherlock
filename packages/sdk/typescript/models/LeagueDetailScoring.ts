...
export function LeagueDetailScoringToJSON(json: any): LeagueDetailScoring {
    return LeagueDetailScoringToJSONTyped(json, false);
}

export function LeagueDetailScoringToJSONTyped(value?: LeagueDetailScoring | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
